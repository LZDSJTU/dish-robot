...
if("TRUE" STREQUAL "TRUE")
  set(handsfree_2dnav_SOURCE_PREFIX /home/liang/robot_ws/src/handsfree_2dnav)
  set(handsfree_2dnav_DEVEL_PREFIX /home/liang/robot_ws/src/cmake-build-debug/devel)
  ...
  set(handsfree_2dnav_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_2dnav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liang/robot_ws/src/handsfree_2dnav/${idir}'.  Ask the maintainer 'luke_liao <luke_liao@126.com>' to fix it.")
    endif()
